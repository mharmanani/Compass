...
# LinearWarmupCosineAnnealingLR taken form pl_bolts.optimizers.lr_scheduler.py

@deprecated('Use LambdaLR with LRCalculator instead.')
...
def get_cosine_lr_scheduler(optimizer, total_epochs, niter_per_ep, warmup_epochs=0):
    return optim.lr_scheduler.LambdaLR(
        optimizer, LinearWarmupCosineAnnealing(warmup_epochs, total_epochs, niter_per_ep)
    )